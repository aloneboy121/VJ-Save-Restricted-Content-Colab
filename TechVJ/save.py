...
async def send_start(client: Client, message: Message):
    buttons = [[
        InlineKeyboardButton("Alone Boy", url = "https://t.me/alonedada143")
    ],[
        InlineKeyboardButton('🔍 Alone Boy Group', url='https://t.me/savebotalonehelp'),
        InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/alonesavebotpaid')
	]]
